...
class Movie (db.Model):
    ...
    # Methohd to create a movie element.
    ...
    # Long format, returns the all the information of the movie
    # including the lists of actors involved in the movie
    def format(self):
        actors = self.actors
    ...
    # Short format, returns all the information of the movie
    # except the actors involved. Used by the format method
    # in Actor class to avoid an infinite callback looping
